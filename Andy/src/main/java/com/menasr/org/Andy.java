...
public class Andy extends Application {
    ...
    public static RToolbar TOOLBAR;
    public static RAnim ANIMATION;
    ...
    private void initializeThings() {
        ...
        TOAST = new Tost();           //initialized Toast Object
        SNACKBAR = new Snack();  //initialized Snack Object
        FILES = new Files();  //initialized FILES Object
        RES = new Res(context);  //initialized Resources Object
