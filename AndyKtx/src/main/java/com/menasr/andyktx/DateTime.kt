...
class DateTime {
     ...
     * You can only use TimeConst.**DAY**,**HOUR** or **MIN**,
    ...
    fun getDifference(startTime: Long?, endTime: Long?, rTimeConst: String): Long? {
        ...
        when (rTimeConst) {
            TimeConst.DAY -> return days
            TimeConst.HOUR -> return days * 24 + hours
    ...
    fun getCurrentTimeStampWithSecRoundOff(millis: Long): String {
        val ct = getDateTimeFromMillis(System.currentTimeMillis(), TimeConst.TIME_24HOUR)
